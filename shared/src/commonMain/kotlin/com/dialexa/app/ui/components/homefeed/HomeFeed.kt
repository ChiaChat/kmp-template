package com.dialexa.app.ui.components.homefeed
...
import com.dialexa.app.model.user.Post
...
internal object HomeFeed {
    ...
    fun HomeButton(onClick: () -> Unit) {
        GraphicButton(graphic = CchGraphics.DIALEXA_ICON, contentDescription = "home", onClick = onClick)
    }
