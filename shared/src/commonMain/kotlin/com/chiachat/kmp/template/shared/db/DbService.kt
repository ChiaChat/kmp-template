package com.chiachat.kmp.template.shared.db
...
class DbService(val driver: SqlDriver) {
    ...
    var db: KmpTemplateDb = KmpTemplateDb.invoke(driver)
    ...
    suspend fun runMigrations() {
        ...
        val latestVersion = KmpTemplateDb.Schema.version
        if (currentVersion == null) {
            ...
            if (currentVersion != latestVersion) {
                KmpTemplateDb.Schema.migrate(driver, currentVersion, latestVersion)
