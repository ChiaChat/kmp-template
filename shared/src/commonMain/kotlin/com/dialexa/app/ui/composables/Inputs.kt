...
import com.dialexa.app.ui.composables.Graphics.Graphic
import com.dialexa.app.ui.composables.Graphics.GraphicButton
...
internal object Inputs : KoinComponent {
    ...
    fun ToggleDarkModeButton() {
        ...
        IconButton(onClick = { themeService.toggleDarkTheme(systemInDarkTheme) }) {
            if (themeService.isDarkMode()) Graphic(CchGraphics.LIGHT_MODE, "Enable light mode")
            else Graphic(CchGraphics.DARK_MODE, "Enable Dark Mode")
        }
    }
    ...
    fun BackButton(onClick: () -> Unit, modifier: Modifier = Modifier) {
        GraphicButton(
            graphic = CchGraphics.BACK_ARROW,
