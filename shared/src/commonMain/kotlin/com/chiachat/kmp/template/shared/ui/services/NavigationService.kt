...
import com.chiachat.kmp.template.shared.ui.components.Component
import org.koin.core.component.KoinComponent

internal class NavigationService(initialScreen: Component, val maxScreens: Int = 10) :
    KoinComponent {
    ...
    // Keeps the screen observable in sync with the index. Must be called wherever the screen index
    // is
    // changed.
